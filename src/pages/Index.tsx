...
import { Trash2, CheckSquare, Github, Twitter, Heart, Facebook } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center p-4">
      ...
      <Card className="w-full max-w-md shadow-lg border-t-4 border-t-blue-500 mb-8">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle className="text-xl font-bold">Team's Tasks</CardTitle>
      ...
      <footer className="w-full max-w-md text-center text-gray-500 text-sm mt-auto">
        <div className="flex justify-center space-x-4 mb-3">
          <a href="https://github.com/taskmaster" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
            <Github className="h-5 w-5" />
          </a>
          <a href="https://twitter.com/taskmaster" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
            <Twitter className="h-5 w-5" />
          </a>
          <a href="https://facebook.com/taskmaster" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
